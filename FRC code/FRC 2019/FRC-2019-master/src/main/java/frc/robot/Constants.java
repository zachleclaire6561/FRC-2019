...
public class Constants{
    ...
    public static final int FORKLIFT_SERVO = 5;
    public static final int CLIMB_MTR_1 = 3;
    public static final int CLIMB_MTR_2 = 4;
    ...
    public static final int DOUBLE_SOLENOID_3 = 2;
    public static final int DOUBLE_SOLENOID_4 = 3;
    ...
    */ 
    ...
    public static final double Elevator_Max_Height = 7;
    ...
    public static final double Elevator_Height_LVL1RCKT_BALL = 0;
    public static final double Elevator_Height_LVL2_BALL = 0;
    public static final double Elevator_Height_LVL3_BALL = 0;
    public static final double Elevator_Height_SHUTTLE_BALL = 0;
